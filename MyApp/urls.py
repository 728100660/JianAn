...
urlpatterns = {
    ...
    url(r'^modify_information/', views.modify_information,
    ...
    url(r'^get_appointment_info/', views.get_appointment_info,
    ...
    url(r'^get_stream_people_week/', views.get_stream_people_week,
        name='get_stream_people_week'),
